...
class SpeedPerk extends BoostPerk:
   ...
   func _init(
      p_name: String = "Speed Perk",
      p_description: String = "increases the players speed",
      p_type: String = "Boost"
      ) -> void:
      super(p_name, p_description, p_type)
...
class HealthPerk extends BoostPerk:
   ...
   func _init(
      p_name: String = "Health Perk",
      p_description: String = "increases the players health",
      p_type: String = "Boost"
      ) -> void:
      super(p_name, p_description, p_type)
...
class StrengthPerk extends BoostPerk:
   ...
   func _init(
      p_name: String = "Strength Perk",
      p_description: String = "increases the players strength",
      p_type: String = "Boost"
      ) -> void:
      super(p_name, p_description, p_type)
